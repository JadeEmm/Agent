...
import { SeekerProfile, Tier } from '@/types';
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-12">   
            ...
            <div className="mt-6 flex items-center justify-start gap-x-6">
                ...
                <button type="submit" className="rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">
                    Create Order
                </button>
            </div>
        </form>
