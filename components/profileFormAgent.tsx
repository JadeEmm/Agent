              ...
              <div className="sm:col-span-6">
                ...
                <div className="mt-2">
                  <textarea
                    ...
                    placeholder='This is a description of your services, your experience, etc. Be as detailed as possible.'
                    className="block w-full h-60 rounded-md border-0 p-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
                  />
